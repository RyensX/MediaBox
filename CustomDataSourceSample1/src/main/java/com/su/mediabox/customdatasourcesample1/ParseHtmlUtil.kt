...
object ParseHtmlUtil {
    ...
    fun parseHeroWrap(      //banner
        ...
        for (i in liElements.indices) {
            ...
            list.add(
                AnimeCoverBean(
                    type, url, CustomConst.MAIN_URL() + url,
        ...
        for (i in elements.indices) {
            ...
            animeShowList.add(
                AnimeCoverBean(
                    ...
                    title, null, "", null, null,
                    AnimeEpisodeDataBean("", episodeUrl, episodeTitle),
                    AnimeAreaBean("", areaUrl, CustomConst.MAIN_URL() + areaUrl, areaTitle),
                    date
                )
            )
        }
    ...
    fun parseNextPages(
        ...
        for (i in results.indices) {
            if (findCurrentPage) {
                ...
                return PageNumberBean(type, url, CustomConst.MAIN_URL() + url, title)
            }
