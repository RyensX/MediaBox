package com.su.mediabox.view.component.bannerview
...
import com.su.mediabox.view.component.bannerview.BannerUtil.getRealPosition
import com.su.mediabox.view.component.bannerview.indicator.Indicator
import com.su.mediabox.view.component.bannerview.indicator.SimpleIndicator
...
open class BannerView(mContext: Context, attrs: AttributeSet?) :
     ...
     */
    fun getAdapter(): RecyclerView.Adapter<*>? = mViewPager2.adapter
