...
public class DanmakuVideoPlayer extends AnimeVideoPlayer {
...
//        mToogleDanmaku = (TextView) findViewById(R.id.toogle_danmaku);
        ...
        //初始化弹幕显示
//        mDumakuFile = new File(Const.AnimeDanmu.Companion.getAnimeDanmuFilePath());
        initDanmaku();
...
//            mParser = createParser(this.getResources().openRawResource(R.raw.comments));
            ...
            mDanmakuView.setCallback(new master.flame.danmaku.controller.DrawHandler.Callback() {
                ...
                public void updateTimer(DanmakuTimer timer) {
                    if (Math.abs(getCurrentPlayer().getSpeed() - 1f) >= 0.001f)
                        timer.update(getCurrentPlayer().getCurrentPositionWhenPlaying());
                }
...
//                    mToogleDanmaku.setText("弹幕开");
    ...
    private BaseDanmakuParser createParser(InputStream stream) {
        ...
        ILoader loader = AnimeDanmakuLoaderFactory.Companion.create(AnimeDanmakuLoaderFactory.Companion.getTAG_ANIME());
        ...
        BaseDanmakuParser parser = new AnimeDanmakuParser();
